...
@protocol PropertyEditorImplementation
...
+ (UIViewController<PropertyEditorImplementation> *)editorForPropertyType:(NSString *)encodeDirectiveType;  // factory method to create a view controller that knows how to edit the given property type. |encodeDirectiveType| is the result of doing @encode(YourProperty).
